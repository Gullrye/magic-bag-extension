...
- [ ] **INFR-03**: Service worker handles privileged Chrome APIs (tabs, contextMenus, storage)
- [ ] **INFR-04**: `unlimitedStorage` permission requested for large tab collections
